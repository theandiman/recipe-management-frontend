...
- **Co-Author Attribution**: Always include co-author attribution in commit messages and PR descriptions:
  `Co-authored-by: Antigravity <antigravity@google.com>`
- **AI-Assisted PR Label**: Always attach `--label "ai-assisted"` (or `"ai-generated"`) when creating pull requests.
