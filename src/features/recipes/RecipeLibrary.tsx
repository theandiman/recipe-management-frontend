      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {[1, 2, 3, 4, 5, 6].map((i) => (
          ...
          >
            ...
            <div className="p-4">
              <h3 className="font-semibold text-gray-900 mb-1">Recipe Title {i}</h3>
              <p className="text-sm text-gray-600 mb-3">A delicious recipe description...</p>
