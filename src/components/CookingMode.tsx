              ...
              <div className="flex gap-4 p-4 bg-gray-50 rounded-lg mb-6">
                {recipe.prepTime && (
                  <div className="flex items-center">
                    ...
                    <span className="text-sm text-gray-700"><span className="font-medium">Prep:</span> {recipe.prepTime}m</span>
                  </div>
                )}
                {recipe.cookTime && (
                  <div className="flex items-center">
                    ...
                    <span className="text-sm text-gray-700"><span className="font-medium">Cook:</span> {recipe.cookTime}m</span>
                  </div>
                )}
                {recipe.servings && (
                  <div className="flex items-center">
                    ...
                    <span className="text-sm text-gray-700"><span className="font-medium">Servings:</span> {recipe.servings}</span>
                  </div>
                )}
              </div>
